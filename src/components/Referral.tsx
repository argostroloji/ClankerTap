...
export const Referral: React.FC<ReferralProps> = ({ isOpen, onClose, userId }) => {
    ...
    const botUsername = 'ClankerTapBot';
    const appName = 'game';
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-panel-bg rounded-t-3xl z-50 p-6 border-t border-primary-purple shadow-[0_-5px_30px_rgba(124,58,237,0.2)] animate-slide-up">
            ...
            <div className="flex justify-between items-start mb-6">
                <div>
                    ...
                    <p className="text-xs text-gray-400 font-medium">Recruit friends, earn <span className="text-primary-purple">+50,000 Snips</span> each.</p>
                </div>
            ...
            <div className="bg-gray-900/50 p-4 rounded-2xl border border-gray-800 mb-6 flex justify-between items-center backdrop-blur-sm">
                ...
                <span className="text-3xl font-black text-primary-purple drop-shadow-md font-sans">{referralCount}</span>
            </div>
            ...
            <div className="bg-black/30 p-4 rounded-xl flex items-center justify-between mb-6 border border-gray-800 hover:border-gray-700 transition-colors">
                <code className="text-xs text-purple-400 truncate flex-1 mr-4 font-mono select-all">
            ...
            <button
                ...
                className="w-full bg-gradient-to-r from-primary-purple to-purple-600 text-black font-black text-lg py-4 rounded-2xl shadow-[0_0_20px_rgba(167,139,250,0.4)] active:scale-95 transition-all hover:brightness-110 flex items-center justify-center gap-2 uppercase tracking-wide"
            >
